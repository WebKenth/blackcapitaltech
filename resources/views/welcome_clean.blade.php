        ...
        <div class="container mx-auto px-6 py-20">
            <div class="max-w-4xl mx-auto text-center">
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center">
                    <a href="#kontakt" class="bg-blue-600 text-white px-8 py-4 rounded-lg font-semibold hover:bg-blue-700 transition-colors">
                        Book en konsultation
                    </a>
                    <a href="#services" class="border-2 border-blue-600 text-blue-600 px-8 py-4 rounded-lg font-semibold hover:bg-blue-50 transition-colors">
                        Se vores services
                    </a>
                </div>
            </div>
